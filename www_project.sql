...
CREATE TABLE IF NOT EXISTS `admin` (
  `name` varchar(20) COLLATE utf-8_general_ci NOT NULL,
  `pass` varchar(40) COLLATE utf-8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf-8 COLLATE=utf-8_general_ci;
...
CREATE TABLE IF NOT EXISTS `books` (
  `book_isbn` varchar(20) COLLATE utf-8_general_ci NOT NULL,
  `book_title` varchar(60) COLLATE utf-8_general_ci DEFAULT NULL,
  `book_author` varchar(60) COLLATE utf-8_general_ci DEFAULT NULL,
  `book_image` varchar(40) COLLATE utf-8_general_ci DEFAULT NULL,
  `book_descr` text COLLATE utf-8_general_ci,
  `book_price` decimal(6,2) NOT NULL,
  `publisherid` int(10) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=utf-8_general_ci;
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `name` varchar(60) COLLATE utf-8_general_ci NOT NULL,
  `address` varchar(80) COLLATE utf-8_general_ci NOT NULL,
  `city` varchar(30) COLLATE utf-8_general_ci NOT NULL,
  `zip_code` varchar(10) COLLATE utf-8_general_ci NOT NULL,
  `country` varchar(60) COLLATE utf-8_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf-8 COLLATE=utf-8_general_ci;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `ship_name` char(60) COLLATE utf-8_general_ci NOT NULL,
  `ship_address` char(80) COLLATE utf-8_general_ci NOT NULL,
  `ship_city` char(30) COLLATE utf-8_general_ci NOT NULL,
  `ship_zip_code` char(10) COLLATE utf-8_general_ci NOT NULL,
  `ship_country` char(20) COLLATE utf-8_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf-8 COLLATE=utf-8_general_ci;
...
CREATE TABLE IF NOT EXISTS `publisher` (
  `publisherid` int(10) unsigned NOT NULL,
  `publisher_name` varchar(60) COLLATE=utf-8_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf-8 COLLATE=utf-8_general_ci;
